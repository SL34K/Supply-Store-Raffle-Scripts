...
def signup(domain,address1,city,state,country,postcode,delay,login, password):
    ...
    sesh = session()
    getlink = sesh.get('https://www.supplystore.com.au/raffle-nike-zoom-fly-mercurial-fkow-total-orangewhite-volt.aspx')
    ...
    data = {
        'cm-f-dykuiyyk': first,
        'cm-f-dykuiyyu': last,
        'cm-uulhukd-uulhukd': email,
        'cm-f-dykuiyjl': phone,
        'cm-fo-dykuiyjh': size,
        'cm-f-dykuiyjr': address1,
        'cm-f-dykuiyjy': city,
        'cm-f-dykuiyil': state,
        'cm-f-dykuiyjj': country,
        'cm-f-dykuiyjt': postcode,
...
def main():
    ...
    log("NIKE ZOOM FLY MERCURIAL FK/OW - TOTAL ORANGE/WHITE-VOLT")
...
sesh = session()
def sizechoice():
    pull = sesh.get('https://www.supplystore.com.au/raffle-nike-zoom-fly-mercurial-fkow-total-orangewhite-volt.aspx')
