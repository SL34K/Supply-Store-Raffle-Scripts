...
def getphone():
    ...
    return pnum
sizes = ['11548317','11532178','11532179','11532180','11532181','11532182','11532183','11532184','11532185','11532186','11532187','11532188']
...
def signup(domain,address1,city,state,country,postcode,delay,login, password):
    ...
    sesh = session()
    getlink = sesh.get('https://www.supplystore.com.au/raffle-air-jordan-4-retro-university-blueblack-varsity-red.aspx')
    ...
    data = {
        'cm-f-dykklkx': first,
        'cm-f-dykklkm': last,
        'cm-uuljtkt-uuljtkt': email,
        'cm-f-dykklkc': phone,
        'cm-fo-dykklkju': size,
        'cm-f-dykklkq': address1,
        'cm-f-dykklka': city,
        'cm-f-dykklkf': state,
        'cm-f-dykklkz': country,
        'cm-f-dykklkv': postcode,
...
def main():
    ...
    log("AIR JORDAN 4 RETRO UNIVERSITY BLUE/BLACK-VARSITY RED")
...
sesh = session()
def sizechoice():
    pull = sesh.get('https://www.supplystore.com.au/raffle-air-jordan-4-retro-university-blueblack-varsity-red.aspx')
